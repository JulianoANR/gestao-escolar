...
<section class="px-4 mt-5 md:px-6 mb-6">
    <div id="alert-border-2" class="flex p-4 mb-4 bg-{{ $color }}-100 border-t-4 border-{{ $color }}-500 dark:bg-{{ $color }}-200" role="alert">
        <svg class="flex-shrink-0 w-5 h-5 text-{{ $color }}-700" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
        </svg>
        <div class="ml-3 text-sm font-medium text-{{ $color }}-700">
            {{-- A simple danger alert with an
            <a href="#" class="font-semibold underline hover:text-{{ $color }}-800">
                example link
            </a>.
